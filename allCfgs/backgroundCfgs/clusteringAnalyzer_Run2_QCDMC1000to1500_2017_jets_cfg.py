...
process.selcetionStudy_Et50 = cms.EDAnalyzer("clusteringAnalyzerAll_jetDistribution",
...
process.selcetionStudy_Et100 = cms.EDAnalyzer("clusteringAnalyzerAll_jetDistribution",
 runType = cms.string("QCDMC1000to1500"), #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTbarMC, DataA, etc. , etc.
 genPartCollection = cms.InputTag("prunedGenParticles"),
  genParticles = cms.InputTag("genParticles"),
  packedGenParticles = cms.InputTag("packedGenParticles"),
...
process.selcetionStudy_Et150 = cms.EDAnalyzer("clusteringAnalyzerAll_jetDistribution",
 runType = cms.string("QCDMC1000to1500"), #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTbarMC, DataA, etc. , etc.
 genPartCollection = cms.InputTag("prunedGenParticles"),
  genParticles = cms.InputTag("genParticles"),
  packedGenParticles = cms.InputTag("packedGenParticles"),
...
process.selcetionStudy_Et200 = cms.EDAnalyzer("clusteringAnalyzerAll_jetDistribution",
 runType = cms.string("QCDMC1000to1500"), #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTbarMC, DataA, etc. , etc.
 genPartCollection = cms.InputTag("prunedGenParticles"),
  genParticles = cms.InputTag("genParticles"),
  packedGenParticles = cms.InputTag("packedGenParticles"),
...
process.selcetionStudy_Et250 = cms.EDAnalyzer("clusteringAnalyzerAll_jetDistribution",
 runType = cms.string("QCDMC1000to1500"), #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTbarMC, DataA, etc. , etc.
 genPartCollection = cms.InputTag("prunedGenParticles"),
  genParticles = cms.InputTag("genParticles"),
  packedGenParticles = cms.InputTag("packedGenParticles"),
...
process.selcetionStudy_Et300 = cms.EDAnalyzer("clusteringAnalyzerAll_jetDistribution",
 runType = cms.string("QCDMC1000to1500"), #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTbarMC, DataA, etc. , etc.
 genPartCollection = cms.InputTag("prunedGenParticles"),
  genParticles = cms.InputTag("genParticles"),
  packedGenParticles = cms.InputTag("packedGenParticles"),
...
fileNames = cms.untracked.vstring("/store/mc/RunIISummer20UL17MiniAODv2/QCD_HT1000to1500_TuneCP5_13TeV-madgraphMLM-pythia8/MINIAODSIM/106X_mc2017_realistic_v9-v2/2520000/01272D1D-0108-7247-9F21-B2EB4EA22964.root"
)
)
process.TFileService = cms.Service("TFileService",fileName = cms.string("clusteringAnalyzer_jetDistribution_QCDMC1000to1500_2017_output.root")
)
