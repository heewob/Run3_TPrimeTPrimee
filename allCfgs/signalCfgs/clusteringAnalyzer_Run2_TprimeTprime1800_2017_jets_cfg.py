...
process.selcetionStudy_Et50 = cms.EDAnalyzer("clusteringAnalyzerAll_NsubJet",
...
process.selcetionStudy_Et100 = cms.EDAnalyzer("clusteringAnalyzerAll_NsubJet",
 runType = cms.string("TprimeTprime1800"), #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTbarMC, DataA, etc. , etc.
 genPartCollection = cms.InputTag("prunedGenParticles"),
  genParticles = cms.InputTag("genParticles"),
  packedGenParticles = cms.InputTag("packedGenParticles"),
...
process.selcetionStudy_Et150 = cms.EDAnalyzer("clusteringAnalyzerAll_NsubJet",
 runType = cms.string("TprimeTprime1800"), #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTbarMC, DataA, etc. , etc.
 genPartCollection = cms.InputTag("prunedGenParticles"),
  genParticles = cms.InputTag("genParticles"),
  packedGenParticles = cms.InputTag("packedGenParticles"),
...
process.selcetionStudy_Et200 = cms.EDAnalyzer("clusteringAnalyzerAll_NsubJet",
 runType = cms.string("TprimeTprime1800"), #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTbarMC, DataA, etc. , etc.
 genPartCollection = cms.InputTag("prunedGenParticles"),
  genParticles = cms.InputTag("genParticles"),
  packedGenParticles = cms.InputTag("packedGenParticles"),
...
process.selcetionStudy_Et250 = cms.EDAnalyzer("clusteringAnalyzerAll_NsubJet",
 runType = cms.string("TprimeTprime1800"), #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTbarMC, DataA, etc. , etc.
 genPartCollection = cms.InputTag("prunedGenParticles"),
  genParticles = cms.InputTag("genParticles"),
  packedGenParticles = cms.InputTag("packedGenParticles"),
...
process.selcetionStudy_Et300 = cms.EDAnalyzer("clusteringAnalyzerAll_NsubJet",
 runType = cms.string("TprimeTprime1800"), #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTbarMC, DataA, etc. , etc.
 genPartCollection = cms.InputTag("prunedGenParticles"),
  genParticles = cms.InputTag("genParticles"),
  packedGenParticles = cms.InputTag("packedGenParticles"),
...
fileNames = cms.untracked.vstring("/store/mc/RunIISummer20UL17MiniAODv2/TprimeTprime_M-1800_TuneCP5_13TeV-madgraph-pythia8/MINIAODSIM/106X_mc2017_realistic_v9-v2/2550000/0D0726A0-A612-8E4F-9CF0-C01C2DE4818A.root"
)
)
process.TFileService = cms.Service("TFileService",fileName = cms.string("clusteringAnalyzer_NsubJet_TprimeTprime1800_2017_output.root")
)
